...
<body>
    ...
    <ol>
        ...
        <%-- _java build path에 추가하는 방법은 자바 프로젝트할 때만!
        웹에서는 Library에 추가해야한다! --%>
    </ol>
    ...
    <%--scriptlet 작성법  // EL을 쓰려면 scope 중 하나에 작성되어 있어야함. --%>
    <% pageContext.setAttribute("num1", 10);%>

    <%-- JSTL 작성법  // HTML코드처럼 작성하는 Java코드 --%>
    ...
    <pre>
        ...
        3) end   : 반복이 종료될 var 값
        4) step  : 반복할 때마다 var의 증가 값 (기본값 1)

        5) items : 반복 접근한 객체(배열, 컬렉션 객체)  <%--// 향상된 for문에서 오른쪽 자리 --%>
