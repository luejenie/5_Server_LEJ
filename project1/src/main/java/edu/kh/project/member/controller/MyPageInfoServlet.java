...
public class MyPageInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// == 얕은 복사
		Member loginMember = (Member)session.getAttribute("loginMember"); //_세션에 있는 loginMember 객체를 얻어옴.
							//_오류남. Member로 다운캐스팅해야 함
		...
		try {
			...
			int result = new MemberService().updateMember(member);   //_서비스를 한번 밖에 사용 안 하니 일회성으로 불러오고 끝내기.
